...
function Splitter() {
    ...
    const handleTipChange = (value: number): void => {
                ...
                <div className="bg-white mt-10 md:mt-20 rounded-t-3xl md:rounded-xl shadow-md p-4 space-y-5 md:space-x-10 mb-4 flex flex-col md:flex-row">
                    <div className="flex flex-col gap-4 justify-between py-5 space-y-10 px-5">
                        ...
                        <div className='mx-3' >
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 text-lg md:text-2xl">
                                <button className={`w-32 md:w-40 py-2 px-3 border border-gray-300 rounded-md bg-teal-800 text-white font-bold hover:bg-teal-300 hover:text-teal-800  ${tipPercentage === 5  ?  'bg-cyan-300 text-cyan-800' : 'bg-teal-800 text-white'}`} onClick={() => handleTipChange(5)}>5%</button>
                                <button className={`w-32 md:w-40 py-2 px-3 border border-gray-300 rounded-md bg-teal-800 text-white font-bold hover:bg-teal-300 hover:text-teal-800  ${tipPercentage === 10 ? 'bg-cyan-300 text-cyan-800' : 'bg-teal-800 text-white'}`} onClick={() => handleTipChange(10)}>10%</button>
                                <button className={`w-32 md:w-40 py-2 px-3 border border-gray-300 rounded-md bg-teal-800 text-white font-bold hover:bg-teal-300 hover:text-teal-800  ${tipPercentage === 15 ? 'bg-cyan-300 text-cyan-800' : 'bg-teal-800 text-white'}`} onClick={() => handleTipChange(15)}>15%</button>
                                <button className={`w-32 md:w-40 py-2 px-3 border border-gray-300 rounded-md bg-teal-800 text-white font-bold hover:bg-teal-300 hover:text-teal-800  ${tipPercentage === 20 ? 'bg-cyan-300 text-cyan-800' : 'bg-teal-800 text-white'}`} onClick={() => handleTipChange(20)}>20%</button>
                                <button className={`w-32 md:w-40 py-2 px-3 border border-gray-300 rounded-md bg-teal-800 text-white font-bold hover:bg-teal-300 hover:text-teal-800  ${tipPercentage === 25 ? 'bg-cyan-300 text-cyan-800' : 'bg-teal-800 text-white'}`} onClick={() => handleTipChange(25)}>25%</button>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-10  bg-teal-800 flex flex-col justify-between w-[42vh] md:w-[45vh] " style={{ backgroundColor: "#008080" }} >
                        <div className="flex flex-col gap-6">
                            ...
                            <div className='flex justify-between' >
                                <div>
                                    <p  className="text-white text-base font-bold block mb-2">Total </p>
                                    <p className="text-white text-sm font-normal block mb-2"> / Person</p>
